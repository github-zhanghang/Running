...
public class DynamicOneselfActivity extends AppCompatActivity implements
    ...
    @Bind(R.id.dynamic_oneself_back_img)
    ImageView mOneselfBackImg;
    @Bind(R.id.dynamic_oneself_tittle)
    TextView mOneselfTittle;
    @Bind(R.id.dynamic_oneself_top_Layout)
    RelativeLayout mOneselfTopLayout;
